...
import 'package:planner_messenger/services/call_service.dart';
import 'package:planner_messenger/services/chat_service.dart';
import 'package:planner_messenger/services/filter_service.dart';
...
class AppServices {
  ...
  static MessengerService baseService() => SGlobalState.get<MessengerService>(
        "_service",
  ...
  static CallService get call =>
      SGlobalState.get<CallService>("_call", orNull: () => CallService(service: AppServices.baseService()))!;

  static FilterService get filter =>
      SGlobalState.get<FilterService>("_filter", orNull: () => FilterService(service: AppServices.baseService()))!;
}
